          ...
          <div class="top-bar color-scheme-bright">
            <div class="fancy-selector-w">
              <div class="fancy-selector-current">
                <div class="fs-img">
                  <img alt="" src="/assets/img/card4.png">
                </div>
                ...
                <div class="col-sm-4 d-none d-lg-block">
                  <div class="cta-w cta-with-media purple">
                    <div class="cta-content">
                      ...
                      <a class="store-google-btn" href="#"><img alt="" src="/assets/img/market-google-play.png"></a>
                    </div>
                    <div class="cta-media">
                      <img alt="" src="/assets/img/phone1.png">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-12 col-xxl-8">
                      <div class="element-wrapper compact pt-4">
                        ...
                        <div class="element-box-tp">
                          <div class="post-box">
                            <div class="post-media" style="background-image: url(/assets/img/portfolio1.jpg)"></div>
                          ...
                          <div class="post-box">
                            <div class="post-media" style="background-image: url(/assets/img/portfolio2.jpg)"></div>
                            <div class="post-content">
                              <h6 class="post-title">
                                Is Crypto the Future of Film Funding?
                              </h6>
