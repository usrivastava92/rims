      ...
      <table style="width: 100%;">
        <tr>
          <td style="background-color: #fff;">
            <img alt="" src="/assets/img/logo.png" style="width: 70px; padding: 20px">
          </td>
          ...
          <table style="width: 100%;">
            <tr>
              <td style="padding: 10px 0px; border-bottom: 1px solid rgba(0,0,0,0.05);">
                <img alt="" src="/assets/img/bigicon7.png" style="width: 70px; height: auto;">
              </td>
            ...
            <tr>
              <td style="padding: 10px 0px; border-bottom: 1px solid rgba(0,0,0,0.05);">
                <img alt="" src="/assets/img/bigicon1.png" style="width: 70px; height: auto;">
              </td>
              <td style="padding-left: 30px; border-bottom: 1px solid rgba(0,0,0,0.05);">
                <div style="font-weight: bold; color: #4B72FA; font-size: 16px;">
            ...
            <tr>
              <td style="padding: 10px 0px;">
                <img alt="" src="/assets/img/bigicon6.png" style="width: 70px; height: auto;">
              </td>
        ...
        <div style="margin-bottom: 20px;">
          <a href="#" style="display: inline-block; margin: 0px 10px;"><img alt="" src="/assets/img/social-icons/twitter.png" style="width: 28px;"></a><a href="#" style="display: inline-block; margin: 0px 10px;"><img alt="" src="/assets/img/social-icons/facebook.png" style="width: 28px;"></a><a href="#" style="display: inline-block; margin: 0px 10px;"><img alt="" src="/assets/img/social-icons/linkedin.png" style="width: 28px;"></a><a href="#" style="display: inline-block; margin: 0px 10px;"><img alt="" src="/assets/img/social-icons/instagram.png" style="width: 28px;"></a>
        </div>
        <div style="margin-bottom: 20px;">
        ...
        <div style="margin-bottom: 20px;">
          <a href="#" style="display: inline-block; margin: 0px 10px;"><img alt="" src="/assets/img/market-google-play.png" style="height: 33px;"></a><a href="#" style="display: inline-block; margin: 0px 10px;"><img alt="" src="/assets/img/market-ios.png" style="height: 33px;"></a>
        </div>
