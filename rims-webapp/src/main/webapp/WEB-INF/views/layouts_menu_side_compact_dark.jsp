                            ...
                            <tr>
                              <td>
                                <div class="user-with-avatar">
                                  <security:authentication var="profilePicUrl" property="principal.userAdditionalInfoPo.profileImageLink">
          <img alt="" src="${userPo.userAdditionalInfoPo.profileImageLink}" onerror="this.src='img/avatar1.jpg'">
        </security:authentication><span class="d-none d-xl-inline-block"><span class="text-capitalize" >${userPo.username}</span></span>
                                </div>
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="user-with-avatar">
                                  <security:authentication var="profilePicUrl" property="principal.userAdditionalInfoPo.profileImageLink">
          <img alt="" src="${userPo.userAdditionalInfoPo.profileImageLink}" onerror="this.src='img/avatar1.jpg'">
        </security:authentication><span><span class="text-capitalize" >${userPo.username}</span></span>
                                </div>
                              </td>
                              <td>
