...
public class Queries {
	...
	public static final String PRODUCT = "insert into product (ID , CREATION_TIME_STAMP ,ACTIVE_FLAG,APPROVAL_STATUS,VISIBILITY , CODE , NAME , DESCRIPTION ) values ({id},systimestamp,TRUE,0,TRUE,'{code}','{name}','{description}');";
	...
	public static final String GENERIC_ATTRIBUTE = "insert into generic_attribute(ID , CREATION_TIME_STAMP ,ACTIVE_FLAG,APPROVAL_STATUS,VISIBILITY , DTYPE , CODE , NAME , DESCRIPTION ) values ({id},systimestamp,TRUE,0,TRUE,'{dtype}','{code}','{name}','{description}');";
