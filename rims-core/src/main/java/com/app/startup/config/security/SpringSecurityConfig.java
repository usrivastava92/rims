package com.app.startup.config.security;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().authorizeRequests().antMatchers("/landing-page", "/auth/login", "/auth/logout")
                .permitAll().antMatchers("/oauth/token").permitAll()
                .antMatchers("/**").access("isAuthenticated()").and().formLogin()
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/css/**", "css/**", "/js/**", "js/**", "/images/**", "images/**", "img/**", "/img/**", "/h2/**", "h2/**",
                "/bower_components/**", "bower_components/**", "/assets/**", "/resources/**", "/static/**",
                "/data/**", "/libs/**", "/**/*/favicon.*", "icon_fonts_assets/**", "apple-touch-icon.png",
