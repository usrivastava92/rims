...
public class PhysicalNamingStrategyImpl extends PhysicalNamingStrategyStandardImpl {
	...
	public Identifier toPhysicalTableName(Identifier name, JdbcEnvironment context) {
		String underScoreText = addUnderscores(name.getText()).toUpperCase();
	...
	private String transformToPluralForm(String tableNameInSingularForm) {
		return DataBaseMappingUtil.abbreviateName(tableNameInSingularForm).toUpperCase();
	}
	...
	private String transformToPluralFormWithSuffix(String tableNameInSingularForm) {
		...
		return nameWithoutSuffix.concat(SUFFIX).toUpperCase();
	}
