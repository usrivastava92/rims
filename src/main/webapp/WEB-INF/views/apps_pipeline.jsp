        ...
        <div class="menu-actions">
          ...
          <div class="top-icon top-settings os-dropdown-trigger os-dropdown-position-right">
            ...
            <div class="os-dropdown">
              ...
              <ul>
                <li>
                  <a href="users_profile_small.html"><i class="os-icon os-icon-ui-49"></i><span>Profile
                      Settings</span></a>
                </li>
                <li>
            ...
            <div class="control-header">
              <div class="row align-items-center">
                ...
                <div class="col-4 col-lg-5 text-right">
                  <a class="btn btn-sm btn-link btn-upper mr-4 d-none d-lg-inline-block" href="#"><i
                      class="os-icon os-icon-ui-44"></i><span>Download CSV</span></a><a
                    class="btn btn-sm btn-primary btn-upper" href="#"><i class="os-icon os-icon-ui-22"></i><span>Add New
                      Lead</span></a>
                </div>
              </div>
            </div>
                    ...
                    <div class="pipeline-body">
                      <div class="pipeline-item">
                        <div class="pi-controls">
                          ...
                          <div class="status status-green" data-placement="top" data-toggle="tooltip"
                      ...
                      <div class="pipeline-item">
                        ...
                        <div class="pi-foot">
                          ...
                          <a class="extra-info" href="#"><i class="os-icon os-icon-mail-12"></i><span>12
                              Notes</span></a>
                        </div>
                      </div>
                      <div class="pipeline-item">
                        ...
                        <div class="pi-body">
                          <div class="avatar">
                            <img alt="" src="/assets/img/avatar6.jpg">
                          </div>
                          <div class="pi-info">
                            <div class="h6 pi-name">
                              Bosing Corp
                    ...
                    <div class="pipeline-body">
                      <div class="pipeline-item">
                        ...
                        <div class="pi-foot">
                          ...
                          <a class="extra-info" href="#"><i class="os-icon os-icon-mail-12"></i><span>14
                              Notes</span></a>
                        </div>
                      </div>
                      <div class="pipeline-item">
                  ...
                  <div class="pipeline white lined-success">
                    ...
                    <div class="pipeline-body">
                      ...
                      <div class="pipeline-item">
                        ...
                        <div class="pi-body">
                          <div class="avatar">
                            <img alt="" src="/assets/img/avatar5.jpg">
                          </div>
                          <div class="pi-info">
                            <div class="h6 pi-name">
                              Ketchup Farm
                    ...
                    <div class="pipeline-body">
                      <div class="pipeline-item">
                        ...
                        <div class="pi-foot">
                          ...
                          <a class="extra-info" href="#"><i class="os-icon os-icon-mail-12"></i><span>15
                              Notes</span></a>
                        </div>
                      </div>
                      <div class="pipeline-item">
