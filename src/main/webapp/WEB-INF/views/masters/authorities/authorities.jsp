              ...
              <div class="element-box">
                ...
                <div class="table-responsive">
                  <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                    ...
                    <tbody>
                      <tr th:each="authority,iter : ${authorities}">
                        <td th:text="${iter.count}">1</td>
                        <td><a th:text="${authority.name}"
                            th:href="@{'/authorities/get/'+${authority.id}}">Edinburgh</a></td>
                        <td th:text="${authority.creationTimeStamp}">2019-10-05 15:32:27.395</td>
                        <td><a th:href="@{'/authorities/get/'+${authority.id}}"><i data-placement="top"
                            ...
                            th:href="@{'/authorities/remove/'+${authority.id}}"><i
