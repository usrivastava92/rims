                    ...
                    <tbody>
                      <c:forEach var="user" items="${users}" varStatus="iter">
                        <tr>
                          <td>${iter.count}</td>
                          <td>
                            <a href="/users/get/${user.id}">${user.username}</a>
                          </td>
                          <td class="text-capitalize">${user.userAdditionalInfoPo.firstname}</td>
                          <td class="text-capitalize">${user.userAdditionalInfoPo.lastname}</td>
                          <td>${user.creationTimeStamp}</td>
                          <td>${user.approvalStatus}</td>
                          <td><a href="/users/get/${user.id}"><i data-placement="top" data-toggle="tooltip"
                              ...
                              href="/users/remove/${user.id}"><i class="text--orange fa fa-times-circle fa-2x"></i></a>
                          </td>
                        </tr>
                      </c:forEach>
                    </tbody>
