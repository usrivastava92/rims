                    ...
                    <div class="up-main-info">
                      <h2 class="up-header">
                        <span class="text-capitalize"
                          th:text="${vendor.name}">Anonymous</span>
                      </h2>
                    ...
                    <form id="formValidate">
                      ...
                      <div class="form-group">
                        <label for=""> Email address</label><input class="form-control"
                          ...
                          type="email" th:value="${vendor.gstNumber}">
                      ...
                      <div class="form-group">
                        <label for=""> Regular select</label><select class="form-control">
                          <option th:each="product : ${vendor.products}" value="${product.name}">
                      ...
                      <div class="form-group">
                        <label for=""> Roles</label><select class="form-control select2" multiple="true">
                          <option th:each="product : ${vendor.products}" value="${product.name}" selected="true">
                            <span th:text="${product.name}">PRODUCT</span>
                          </option>
                        </select>
                      </div>
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label for=""> First Name</label><input class="form-control"
                                ...
                                type="text" th:value="${vendor.name}">
                              <div class="help-block form-text with-errors form-control-feedback"></div>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label for="">Last Name</label><input class="form-control"
                                ...
                                type="text" th:value="${vendor.gstNumber}">
                              <div class="help-block form-text with-errors form-control-feedback"></div>
                            </div>
                          </div>
                        </div>
