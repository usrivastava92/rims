                ...
                <div class="user-profile compact">
                  <div class="up-head-w" style="background-image:url(/assets/img/profile_bg1.jpg)">
                    ...
                    <div class="up-main-info">
                      <h2 class="up-header">
                        <span class="text-capitalize" th:text="${role.name}">Anonymous</span>
                      </h2>
                    ...
                    <form id="formValidate">
                      ...
                      <div class="form-group">
                        <label for=""> Regular select</label><select class="form-control">
                          <option th:each="authority : ${role.authorities}" value="${authority.name}">
                            <span th:text="${authority.name}">AUTHORITY</span>
                          </option>
                        </select>
                      </div>
                      <div class="form-group">
                        <label for=""> Authorities</label><select class="form-control select2" multiple="true">
                          <option th:each="authority : ${role.authorities}" value="${authority.name}" selected="true">
                            <span th:text="${authority.name}">AUTHORITY</span>
                          </option>
                        </select>
                      </div>
